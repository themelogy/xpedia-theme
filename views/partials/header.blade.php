<div class="x_top_header_wrapper float_left">
    <div class="container">
        <div class="x_top_header_left_side_wrapper float_left">
            <p><a href="tel:{{ setting('theme::phone') }}">@setting('theme::mobile')</a></p>
        </div>
        <div class="x_top_header_right_side_wrapper float_left">
            ...
            <div class="x_top_header_all_select_box_wrapper">
                <ul>
                    @auth
                        <li><a href="{{ route('dashboard.index') }}"><i class="fa fa-dashboard"></i> Yönetim Paneli</a></li>
                        <li><a href="{{ LaravelLocalization::getLocalizedURL(locale(), route('logout')) }}"><i class="fa fa-power-off"></i> Çıkış</a></li>
                    @endauth
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            <div class=" col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12">
                <div class="hs_logo_wrapper d-none d-sm-none d-xs-none d-md-block">
                    <a href="@homepage">
                        <img src="{{ Theme::url('images/logo/logo.svg') }}" class="img-responsive" alt="@setting('theme::company-name')"
            ...
            <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
                <nav class="hs_main_menu d-none d-sm-none d-xs-none d-md-block">
                    {!! Menu::render('header', \Themes\Xpedia\Presenter\HeaderMenuPresenter::class) !!}
                </nav>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-6 col-sm-6 col-6">
                                <div class="hs_logo">
                                    <a href="@homepage">
                                        <img src="{{ Theme::url('images/logo/logo.svg') }}" alt="@setting('theme::company-name')" title="@setting('theme::company-name')">
                                    </a>
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-6">
                                ...
                                {!! Menu::render('header', \Themes\Xpedia\Presenter\MobileMenuPresenter::class) !!}
                                <!-- .cd-dropdown-content -->
                                </nav>
                            </div>
                        </div>
