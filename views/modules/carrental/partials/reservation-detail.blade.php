<div class="booking-item-payment mb20">
    <header class="clearfix">
        <a class="booking-item-payment-img mt15" href="{{ $car->url }}">
            <img src="{{ $car->present()->firstImage(200,null,'resize',80) }}" alt="{{ $car->fullname }}" title="{{ $car->fullname }}" />
        </a>
    ...
    <ul class="booking-item-payment-details">
        <li class="mb5">
            ...
            <a class="badge badge-secondary pull-right" href="{{ $car->url }}"><i class="fa fa-calendar"></i> Tarih Değiştir</a>
        </li>
        <li>
            <table class="table">
                <tr>
